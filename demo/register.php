                        ...
                        <div class="box">
                            ...
                            <form action="register.php" method="post" data-toggle="validator">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name-re" data-error="Please enter name field." required>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
                                    <label for="email-re">Email</label>
                                    <input type="email" class="form-control" name="email-re" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
                                    <label for="password-re">Password</label>
                                    <input type="password" class="form-control" name="password-re" data-minlength="5" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
                                <label for="inputPasswordConfirm">Confirm Password</label>
                                    <input type="password" class="form-control" name="inputPasswordConfirm" data-match="#password-login" data-match-error="Whoops, these don't match" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">  
                                ...
                                <div class="text-center">
                                    <button  name="register" class="btn btn-template-main"><i class="fa fa-user-md"></i> Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
