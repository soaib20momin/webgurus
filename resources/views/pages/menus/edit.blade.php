...
<head>
    ...
    <title>Career Insights | Update Menu</title>
                ...
                <div class="row vertical-center-row">
                    <div class="text-center col-md-6 col-md-offset-3">
                        <div class="box">
                            ...
                            <p class="text-muted">Please Edit Menu.</p>
                            ...
                            <form id="checkboxForm" action="{{ route('menus.update', $menu->menu_id) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                                <div class="form-group">
                                    <label for="menu_name">Menu Name</label>
                                    <input type="text" size="5" class="form-control" value="{{$menu->menu_name}}" name="slider_name">
                                </div>
                                <div class="form-group">
                                    <label for="menu_link">Menu Link</label>
                                    <input type="text" size="5" class="form-control" value="{{$menu->menu_name}}" name="menu_name">
                                </div>
                                <div class="form-group">
                                    <label for="parent_id">Parent</label>
                                    <input type="text" size="5" class="form-control" value="{{$menu->parent_id}}" name="parent_id">
                                </div>
                                <br/>
