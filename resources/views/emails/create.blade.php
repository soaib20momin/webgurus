                                ...
                                <form role="form" method="get" action="#">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step2">
                                            ...
                                            <li>
                                                <input class="form-check-input" type="checkbox" name="recipients[]" value="{{$email->email}}" id="defaultCheck1">
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step3">
                                            ...
                                            <ul class="list-inline pull-right">
                                                <li>
                                                <input type="submit" value="Save and continue" class="btn btn-primary btn-info-full next-step">                                                 
                                            </ul>
                                        </div>
